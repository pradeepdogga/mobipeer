package myfirstapp.mobipeer.com.myfirstapp.rtp;
...
import myfirstapp.mobipeer.com.myfirstapp.rtcp.SenderReport;
...
//							Log.d("RTP","Sending to Left Child : " + MainActivity.LeftchildIP + " " + RtspServer.ports[0]);
						...
						if(!MainActivity.RightchildIP.equals("") && RtspServer.sendright==true){
//							Log.d("RTP","Sending to Right Child : " + MainActivity.RightchildIP + " " + RtspServer.ports[2]);
							mPackets[mBufferOut].setAddress(InetAddress.getByName(MainActivity.RightchildIP));
