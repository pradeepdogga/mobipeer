...
import myfirstapp.mobipeer.com.myfirstapp.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(myfirstapp.mobipeer.com.myfirstapp.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(myfirstapp.mobipeer.com.myfirstapp.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link myfirstapp.mobipeer.com.myfirstapp.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		if (sPipeApi == PIPE_API_LS) {
			...
			final String LOCAL_ADDR = "myfirstapp.mobipeer.com.myfirstapp-";
